...
const CACHE_NAME = 'crypto-tracker-cache-v2';
...
self.addEventListener('fetch', (event) => {
    // Excluir peticiones de API (CoinGecko, Alpha Vantage, Gemini)
    if (event.request.url.includes('api.coingecko.com') || event.request.url.includes('alphavantage.co') || event.request.url.includes('generativelanguage.googleapis.com')) {
